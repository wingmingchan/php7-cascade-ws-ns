# php7-cascade-ws-ns
My Cascade web service library, using namespaces, written in PHP 7. Last modified: Sep 8, 2016, 1:40 PM
...
DynamicMetadataFieldDefinition, PossibleValue, and associated test code</li>
