...
<p>Since these eight properties and related methods are shared by <a href=\"/cascade-admin/web-services/api/asset-classes/destination.php\"><code>Destination</code></a>, <a href=\"/cascade-admin/web-services/api/asset-classes/publish-set.php\"><code>PublishSet</code></a> and <a href=\"/cascade-admin/web-services/api/asset-classes/site.php\"><code>Site</code></a></code>, I decide to create an abstract class named <code>ScheduledPublishing</code>, which serves as the parent class of these three classes, and provides all the relevant methods in this class.</p>
<h2>Design Issues</h2>
