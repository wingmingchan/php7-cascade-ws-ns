...
site
  ...
  accessibilityCheckerEnabled (8.11)
  widenDamIntegrationEnabled (8.11)
  widenDamIntegrationCategory (8.11)
  webdamDamIntegrationEnabled (8.11)
  rootFolderId
  ...
  rootSharedFieldContainerId (8.11)
...
/**
<documentation><description><p>Returns <code>accessibilityCheckerEnabled</code>.</p></description>
<example>echo u\StringUtility::boolToString( $s->getAccessibilityCheckerEnabled() ), BR;</example>
<return-type>bool</return-type>
<exception></exception>
</documentation>
*/
    public function getAccessibilityCheckerEnabled() : bool
    {
        return $this->getProperty()->accessibilityCheckerEnabled;
    }
...
*/
    public function getRootSharedFieldContainer() : Asset
    {
...
/**
<documentation><description><p>Returns <code>webdamDamIntegrationEnabled</code>.</p></description>
<example>echo u\StringUtility::boolToString( $s->getWebdamDamIntegrationEnabled() ), BR;</example>
<return-type>bool</return-type>
<exception></exception>
</documentation>
*/
    public function getWebdamDamIntegrationEnabled() : bool
    {
        return $this->getProperty()->webdamDamIntegrationEnabled;
    }
...
*/
    ...
    private $root_shared_field_container;
