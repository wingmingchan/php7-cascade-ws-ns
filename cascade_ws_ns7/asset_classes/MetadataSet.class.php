...
/**
  ...
  * 1/14/2019 Updated addDynamicFieldDefinition and addField with helpText.
...
*/
    public function addDynamicFieldDefinition( string $field_name, string $type, string $label, 
        bool $required=false, string $visibility=c\T::VISIBLE, string $possible_values="",
        string $helpText="" ) : Asset
    {
...
*/
        ...
        string $helpText="" ) : Asset
    {
        return $this->addDynamicFieldDefinition(
            $field_name, $type, $label, $required, $visibility, $possible_values, $helpText );
    }
