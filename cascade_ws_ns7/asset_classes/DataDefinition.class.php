...
/**
  ...
  * 11/2/2018 Added resolveSharedFields and relevant fields.
...
the data is rejected by Cascade, no warnings will be issued from this class.</p>
...
<p>When dealing with the new <code>SharedField</code> class, I use inline replacement to
replace (or to resolve) all <code>shared-field</code> elements with code read from the
corresponding <code>SharedField</code> objects. This happens in the constructor. After an
object of this class is instantiated, the object does not work with
<code>SharedField</code> objects any more. Instead, it only works with the resolved XML.
For example, <code>getIdentifiers</code> returns all FQIs, including those defined in
<code>SharedField</code> objects.</p>
<h2>WSDL</h2>";
$doc_string .=
...
/**
<documentation><description><p>Returns an XML string, with all <code>shared-field</code>
elements replaced with the code of the corresponding <code>SharedField</code> xml. If
the XML does not contain any <code>shared-field</code> elements, then the method returns
the original <code>xml</code>.</p></description>
<example>$xml = $dd->getResolvedXml();</example>
<return-type>string</return-type>
<exception></exception>
</documentation>
*/
    public function getResolvedXml() : string
    {
        return $this->xml;
    }
...
/**
<documentation><description><p>Returns <code>xml</code>. This string may contain <code>shared-field</code> elements.</p></description>
